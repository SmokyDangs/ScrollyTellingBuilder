...
const { settings, hotspots, editorModelOptions, sectionVisualLabels } = Config;
...
async function init() {
    renderer = new THREE.WebGLRenderer({ antialias: !Config.isMobile, alpha: true, powerPreference: "high-performance" });
    renderer.setPixelRatio(Math.min(window.devicePixelRatio, Config.isMobile ? 1 : 2));
